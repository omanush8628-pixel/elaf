      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <Link to="/" className="flex items-center gap-3 text-xl font-black tracking-tighter">
            <img src="https://i.postimg.cc/L4QXJFK8/Screenshot-2026-04-01-193234.png" alt="Logo" className="h-10 w-10 object-cover rounded-full shadow-md" referrerPolicy="no-referrer" />
