...
export default function CheckoutModal({ onClose, cartItems, onSubmit }: { onClose: () => void, cartItems: any[], onSubmit: (data: any) => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white dark:bg-gray-900 dark:text-gray-100 p-8 rounded-lg w-full max-w-lg transition-colors duration-300">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-4 mt-6">
            <button type="button" onClick={onClose} className="flex-1 bg-gray-200 dark:bg-gray-800 py-2 rounded">Cancel</button>
